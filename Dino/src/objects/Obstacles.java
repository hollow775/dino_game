...
public class Obstacles {
    ...
    public Obstacles(int firstPos) {
        ...
        imageList.add(new GetImage().getImage("../Imagens/Cactus-1.png"));
        imageList.add(new GetImage().getImage("../Imagens/Cactus-2.png"));
        imageList.add(new GetImage().getImage("../Imagens/Cactus-3.png"));
        imageList.add(new GetImage().getImage("../Imagens/Cactus-4.png"));
        imageList.add(new GetImage().getImage("../Imagens/Cactus-5.png"));
